...
from model.models.msfv3_conv_model import (
    MSFv3Conv,
    MSFGv3Conv,
    MSFG2v3Conv,
)
...
CSV_COLUMNS = [
    ...
    "spatial_scales",
    "decoder_refine_mode",
    "decoder_refine_hidden",
    "decoder_refine_depth",
    "train_mse",
    "train_rmse",
    "train_mae",
    "train_mape",
...
def main():
    ...
    # per-scale conv refiner options
    cfg.setdefault("decoder_refine_hidden", None)
    cfg.setdefault("decoder_refine_depth", 5)
    cfg.setdefault("decoder_refine_mode", "residual")
    ...
    ModelCls = (
        MSFv3Conv if cfg["fusion"] == "sum"
        else MSFGv3Conv if cfg["fusion"] == "gated"
        else MSFG2v3Conv
    )
    ...
    model = ModelCls(
        ...
        decoder_refine_hidden=cfg["decoder_refine_hidden"],
        decoder_refine_depth=cfg["decoder_refine_depth"],
        decoder_refine_mode=cfg["decoder_refine_mode"],
    ).to(device)
