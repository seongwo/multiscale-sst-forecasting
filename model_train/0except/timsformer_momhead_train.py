...
from model.models.timesformer_model_momhead import TimeSformer_MoMHead
...
CSV_COLUMNS = [
    ...
    "head_num_experts", "head_top_k", "head_temperature", "aux_balance_coef", "aux_z_coef", "aux_coef",
]
...
def main():
    ...
    cfg.setdefault("exp_name", "TimeSformer_momhead")
    cfg.setdefault("results_csv", "./results/TimeSformer_momhead_results.csv")
    ...
    cfg.setdefault("aux_coef", 1.0)         # trainer2에서 aux_loss 가중치
