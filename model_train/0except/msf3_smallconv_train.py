...
from model.models.msf3_smallconv_model import (
    MSFv3SmallConv,
    MSFGv3SmallConv,
    MSFG2v3SmallConv,
)
...
def main():
    ...
    cfg.setdefault("decoder_refine_mode", "residual")  # residual or replace
    ...
    device = cfg["device"]
    ModelCls = (
        MSFv3SmallConv if cfg["fusion"] == "sum"
        else MSFGv3SmallConv if cfg["fusion"] == "gated"
        else MSFG2v3SmallConv
    )
