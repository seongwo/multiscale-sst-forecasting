...
def main():
    ...
    exp_name = cfg.get("exp_name", "simvp_base")
    ...
    base = {
        ...
        "tin": cfg["input_len"],
        "tout": cfg["pred_len"],
        "train_range": f"{cfg['train_start']}~{cfg['train_end']}",
        "val_range": f"{cfg['val_start']}~{cfg['val_end']}",
        "test_range": f"{cfg['test_start']}~{cfg['test_end']}",
        "lr": cfg["lr"],
