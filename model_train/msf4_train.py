...
from model.models.msf4_model import MSFv3, MSFGv3, MSFG2v3
...
def main():
    ...
    cfg.setdefault("fusion", "sum")  # "sum" or "gated"
    ...
    # v3 모델 선택
    ModelCls = MSFv3 if cfg["fusion"] == "sum" else MSFGv3 if cfg["fusion"] == "gated" else MSFG2v3
