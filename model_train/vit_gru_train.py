...
def main():
    ...
    cfg.setdefault("exp_name", "tv_vit_temporal_gru")
    cfg.setdefault("results_csv", "./results/tv_vit_temporal_gru_results.csv")

    # ---- vit hyperparams (you can tune these)
    cfg.setdefault("image_size", 32)     # your data is 32x32
    cfg.setdefault("patch_size", 4)     # wrapper patch = 4
    cfg.setdefault("embed_dim", 128)    # you want smaller than timm (192)
    ...
    # ---- mask + datasets (your build_datasets requires mask)
    ...
    base = {
        "exp_name": exp_name,
        "model": "TorchVisionViTTemporalGRU",
        "tin": cfg["input_len"],
        "tout": cfg["pred_len"],
        "lr": cfg["lr"],
