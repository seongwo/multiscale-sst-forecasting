...
def main():
    ...
    cfg.setdefault("exp_name", "msfv3_encoding")
    cfg.setdefault("results_csv", "./results/msfv3_encoding_results.csv")
    ...
    cfg.setdefault("use_time_emb", True)
    cfg.setdefault("use_scale_emb", True)
    cfg.setdefault("use_pos_emb", False)
    cfg.setdefault("freeze_time_emb", False)
    cfg.setdefault("freeze_scale_emb", False)
    cfg.setdefault("freeze_pos_emb", False)
    ...
    model = ModelCls(
        ...
        fusion=cfg["fusion"],
        use_pad=cfg["use_pad"],
        use_time_emb=cfg["use_time_emb"],
        use_scale_emb=cfg["use_scale_emb"],
        use_pos_emb=cfg["use_pos_emb"],
        freeze_time_emb=cfg["freeze_time_emb"],
        freeze_scale_emb=cfg["freeze_scale_emb"],
        freeze_pos_emb=cfg["freeze_pos_emb"],
    ...
    base = {
        ...
        "use_time_emb": int(bool(cfg["use_time_emb"])),
        "use_scale_emb": int(bool(cfg["use_scale_emb"])),
        "use_pos_emb": int(bool(cfg["use_pos_emb"])),
        "freeze_time_emb": int(bool(cfg["freeze_time_emb"])),
        "freeze_scale_emb": int(bool(cfg["freeze_scale_emb"])),
        "freeze_pos_emb": int(bool(cfg["freeze_pos_emb"])),
    }
